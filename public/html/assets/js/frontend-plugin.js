jQuery(document).ready(function ($) {
    "use strict";
    function oemone_google_maps() {
        if ($('.oemone-google-maps').length <= 0) {
            return;
        }
        $('.oemone-google-maps').each(function () {
            var $this = $(this),
                $id = $this.attr('id'),
    ...
    function oemone_init_menu_toggle() {
        var contain = '.oemone-nav-toggle';
    ...
    // ----------oemone_custom_scrollbar-------------------
    function oemone_custom_scrollbar() {
        $('.oemone-mini-cart .minicart-items').mCustomScrollbar();
        $('.oemone-mini-cart .minicart-items').change(function () {
            $('.oemone-mini-cart .minicart-items').mCustomScrollbar();
        });
    }

    function oemone_custom_scrollbar_header_nav() {
    ...
    //------------------ Video Lightbox------------
    function oemone_video() {
        $('.quick-install').simpleLightboxVideo();
    }

    // --------------------remove_class_equal--------------------------
    function oemone_remove_class_review() {
    ...
    // -----------oemone_details_thumd--------------------
    function oemone_details_thumd_zoom() {
        /* ------------------------------------------------
         Arctic modal
         ------------------------------------------------ */
        if ($.arcticmodal) {
    ...
    /* TOGGLE */
    function oemone_dropdown() {
        $(document).on('click', '.header-control .close', function () {
            $(this).closest('.oemone-dropdown').removeClass('open');
        });
        $(document).on('click', function (event) {
            var _target = $(event.target).closest('.oemone-dropdown');
            var _allparent = $('.oemone-dropdown');

            if (_target.length > 0) {
                _allparent.not(_target).removeClass('open');
                if (
                    $(event.target).is('[data-oemone="oemone-dropdown"]') ||
                    $(event.target).closest('[data-oemone="oemone-dropdown"]').length > 0
                ) {
                    _target.toggleClass('open');
                    return false;
                }
            } else {
                $('.oemone-dropdown').removeClass('open');
            }
        });
    }

    function oemone_mobile_block() {
    ...
    /* ---------------------------------------------
     TAB EFFECT
     --------------------------------------------- */
    function oemone_tab_fade_effect() {
        // effect click
        $(document).on('click', '.oemone-tabs .tab-link a', function () {
...
// ------------------owl-thumbs-----------------------------------------------
    ...
    function oemone_countdown() {
        if ($('.oemone-countdown').length > 0) {
            ...
            $('.oemone-countdown').each(function () {
    ...
    $(window).resize(function () {
        ...
        oemone_masonry()
        kt_resizeMegamenu();
        oemone_remove_class_review();
        oemone_details_thumd_zoom();
        oemone_custom_scrollbar();
    });
    $(window).load(function () {
        newletter_popup();
    ...
    oemone_masonry()
    oemone_dropdown();
    oemone_init_carousel();
    oemone_remove_class_review();
    oemone_tab_fade_effect();
    oemone_details_thumd_zoom();
    oemone_video();
    kt_resizeMegamenu();
    oemone_custom_scrollbar();
    oemone_countdown();
    oemone_init_menu_toggle();
    oemone_custom_scrollbar_header_nav();
}); 